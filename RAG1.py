...
def example_4a_contract_analysis_from_library (model_name, verbose=False):
    ...
    contracts_path = sample_files_path

    contracts_lib = Library().create_new_library("example22_library")
    ...
    question_list = [{"topic": "Team", "llm_query": "who is from team risk management?"}]
    ...
    prompter = Prompt().load_model(model_name, use_gpu=False)
